...
- [x] system tests: MUST produce document detailing the test environment, to include details including configuration on source/sink cluster setups, kafka setup
